...
export default function JuegosJuguetes() {
  ...
  useEffect(() => {
    const fetchProducts = async () => {
      try {
        setLoading(true);
        // Buscar productos con palabras clave relacionadas con juegos y juguetes
        const searchTerms = ['toys', 'games', 'play', 'educational', 'puzzle'];
        const allProducts = [];
        ...
        setError('Error al cargar los productos de juegos y juguetes');
  ...
  return (
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
      <h2 className="text-3xl font-bold text-gray-900 mb-8">Juegos y juguetes</h2>
